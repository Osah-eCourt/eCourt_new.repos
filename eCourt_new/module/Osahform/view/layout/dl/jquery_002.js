...
}function bC(b2){if(bh[b2]){return bh[b2]
}var bZ=bG("<"+b2+">").appendTo(o.body),b1=bZ.css("display");
bZ.remove();
if(b1==="none"||b1===""){az=o.body.appendChild(az||bG.extend(o.createElement("iframe"),{frameBorder:0,width:0,height:0}));
try{if(!aW||!az.createElement){aW=(az.contentWindow||az.contentDocument).document;
aW.write("<!doctype html><html><body>");
aW.close()
}bZ=aW.body.appendChild(aW.createElement(b2));
b1=E(bZ,"display");
