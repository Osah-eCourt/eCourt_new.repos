...
$doctype1=$_POST["doctypeval"];
$doctype=str_replace(' ', '', $doctype1);
$folderdatename=$_POST["folderdatename"];

if (file_exists("C:/project/zend/Apache2/htdocs/osahcms/public/upload/".$dirname)) {
	
	$upload_path = "upload/".$dirname . "/"; // where image will be uploaded, relative to this file
